...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Ph.D. in Systems Biology}{Pasadena, CA}
    \resumeSubheading
      {University of California, San Diego}{Aug.\ 2017 -- June 2021}
      {B.S. in Molecular Biology, Minor in Mathematics (GPA: 3.75)}{La Jolla, CA}
      \resumeItemListStart
        \resumeItem{Selected coursework: Bioinformatics, Biophysics, Computational Linear Algebra,\\ Dynamical Systems, Gene Regulation, Gene Editing, Statistics, Stochastic Processes}
      \resumeItemListEnd
    \resumeSubheading
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{Rotation Student}{Sep.\ 2021 -- Dec.\ 2021}
      {Lab of Rob Phillips, Caltech}{Pasadena, CA}
      \resumeItemListStart
        \resumeItem{Studying microbial gene regulation using MPRAs and statistical mechanics}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Investigated cost-performance trade-offs in the \emph{Arabidopsis} root system using\\ high-throughput phenotyping and graph-theoretic modeling}
        \resumeItem{Created a Python GUI for segmenting time-series images of root growth}
        \resumeItem{Helped develop algorithms for plant phenotyping from noisy 3D point clouds}
        \resumeItem{Built a pipeline for co-expression network analysis of scRNA-seq data\\ to identify genetic targets for future crop engineering}
      \resumeItemListEnd
    \resumeSubheading
      {Volunteer Research Assistant}{Nov.\ 2018 -- Nov.\ 2019}
      {Lab of Patrick Hsu, Salk Institute for Biological Studies}{La Jolla, CA}
      \resumeItemListStart
        \resumeItem{Developed an automated pipeline to mine metagenomes for new orthologs of\\ CRISPR-Cas13d, and searched over 20TB of sequence data}
        \resumeItem{Assisted in performing a pooled 150,000-guide Cas13d screen in K562s\\ to optimize gRNA design}
    \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Publications}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Branch-Pipe: Improving graph skeletonization around branch points in 3D point clouds.}}{}
          \resumeItemListStart
...
\section{Preprints}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Deep learning of Cas13 guide activity from high-throughput gene essentiality screening.}}{}
          \resumeItemListStart
